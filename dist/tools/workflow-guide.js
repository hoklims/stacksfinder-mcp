 ...
 */
export const WORKFLOW_CONTEXTS = ['chatgpt', 'claude', 'cursor', 'cli'];
/**
 * User tiers
 */
export const USER_TIERS = ['free', 'pro', 'unknown'];
/**
...
const WORKFLOWS = {
    ...
    install_mcp: {
        ...
        fallbackMessage: 'For ChatGPT users without CLI access, visit https://stacksfinder.com/guides/mcp for manual setup instructions.'
    },
    compare_techs: {
        goal: 'compare_techs',
 ...
 */
export function executeGetWorkflowGuide(input) {
    ...
    const goal = current_goal && WORKFLOW_GOALS.includes(current_goal) ? current_goal : 'discover';
